...
class NextFlightsController extends Controller {
    ...
    protected function create() {
        ...
        $arrivingFlights = $searcherController->searchArrivingFlightsfromHomeView($_POST['aircraftField'], $_POST['airportToField'], $_POST['airportFromField'], $_POST['departDateField'], $_POST['arrivalDateField'], $_POST['filter']);
